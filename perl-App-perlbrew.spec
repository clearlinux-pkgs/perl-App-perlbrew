...
Source0  : https://cpan.metacpan.org/authors/id/G/GU/GUGOD/App-perlbrew-0.93.tar.gz
...
%prep
%setup -q -n App-perlbrew-0.93
cd %{_builddir}/App-perlbrew-0.93
...
cp %{_builddir}/App-perlbrew-0.93/LICENSE %{buildroot}/usr/share/package-licenses/perl-App-perlbrew/3f12f928da67f22daa38e4df02a3c1640d1fbcd1
if test -f Makefile.PL; then
