...
Source0  : https://cpan.metacpan.org/authors/id/G/GU/GUGOD/App-perlbrew-1.02.tar.gz
...
%prep
%setup -q -n App-perlbrew-1.02
cd %{_builddir}/App-perlbrew-1.02
pushd ..
cp -a App-perlbrew-1.02 buildavx2
popd
