...
Source0  : https://cpan.metacpan.org/authors/id/G/GU/GUGOD/App-perlbrew-1.00.tar.gz
...
%prep
%setup -q -n App-perlbrew-1.00
cd %{_builddir}/App-perlbrew-1.00
pushd ..
cp -a App-perlbrew-1.00 buildavx2
popd
