...
Source0  : https://cpan.metacpan.org/authors/id/G/GU/GUGOD/App-perlbrew-0.89.tar.gz
...
%prep
%setup -q -n App-perlbrew-0.89
cd %{_builddir}/App-perlbrew-0.89
...
cp %{_builddir}/App-perlbrew-0.89/LICENSE %{buildroot}/usr/share/package-licenses/perl-App-perlbrew/7cde926945f824d6ae17697c4893298bc7681ebb
if test -f Makefile.PL; then
